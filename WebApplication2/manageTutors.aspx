    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <div class="main-content">
                ...
                <div style="margin-left: 711px">
 <h2>Existing Tutors</h2>
            <asp:GridView ID="GridViewExistingTutors" runat="server" AutoGenerateColumns="False" style="text-align: center" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="TutorID" OnSelectedIndexChanged="GridViewExistingTutors_SelectedIndexChanged">
            ...
            <asp:GridView ID="GridViewNewTutors" runat="server" AutoGenerateColumns="False" style="text-align: center" CellPadding="4" ForeColor="#333333" GridLines="None" DataKeyNames="TutorID" OnSelectedIndexChanged="GridViewNewTutors_SelectedIndexChanged">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:BoundField DataField="TutorID" HeaderText="TutorID" InsertVisible="False" ReadOnly="True" SortExpression="TutorID" />
                ...
                <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                    ...
                    <asp:SqlDataSource ID="NewTutor" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [NewTutorsTable]"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </form>
