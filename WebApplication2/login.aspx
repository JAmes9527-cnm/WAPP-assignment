<%@ Page Language="C#" MasterPageFile="~/masterPage.master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="WebApplication2.newLogin" %>
    ...
    <script>
        ...
        function startCountdown() {
            ...
            seconds = 30;
            document.getElementById('countdown').innerText = 'OTP is valid for ' + seconds + ' seconds.';
            document.getElementById('<%= ResendOTPButton.ClientID %>').disabled = true;
            countdownTimer = setInterval(function () {
                ...
                if (seconds <= 0) {
                    ...
                    document.getElementById('<%= ResendOTPButton.ClientID %>').disabled = false;
                    disableOTP();
                }
            }, 1000);
        }
        ...
        function disableOTP() {
            document.getElementById('<%= otp.ClientID %>').disabled = true;
