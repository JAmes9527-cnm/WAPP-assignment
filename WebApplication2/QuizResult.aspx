...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div class="form-container">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
            ...
            UpdateCommand="UPDATE [ResultTable] SET StudentID=@StudentID, Quiz=@Quiz, Q1=@Q1, StudentAnswer1=@StudentAnswer1, CorrectAnswer1=@CorrectAnswer1, Result1=@Result1, Q2=@Q2, StudentAnswer2=@StudentAnswer2, CorrectAnswer2=@CorrectAnswer2, Result2=@Result2, Q3=@Q3, StudentAnswer3=@StudentAnswer3, CorrectAnswer3=@CorrectAnswer3, Result3=@Result3, TotalResult=@TotalResult WHERE Id=@Id">
            <UpdateParameters>
